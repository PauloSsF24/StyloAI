    ...
    <div className="min-h-screen bg-gray-50 p-10">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-10">
          <h1 className="text-3xl font-bold text-purple-700">Meus Looks</h1>
          <button onClick={() => setIsOpen(true)} className="bg-purple-700 text-white px-5 py-2 rounded-xl hover:opacity-80 transition">
            + Novo Look
          </button>
        </div>
        ...
        {looks.length === 0 ? (
          <p className="text-gray-500">Nenhum look cadastrado ainda.</p>
        ) : (
            ...
            {looks.map((look) => (
              ...
              >
                <Image
                  ...
                  priority={false}
                />
                <h3 className="font-semibold text-lg mt-4">{look.nome}</h3>
                <p className="text-sm text-gray-500">
                  Ocasião: {look.ocasiao}
                </p>
                <p className="text-sm text-gray-500">
                  Clima: {look.clima.charAt(0).toUpperCase() + look.clima.slice(1)}
                </p>
